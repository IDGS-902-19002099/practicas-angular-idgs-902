...
export class ResistenciasComponent {
  ...
  resistencia!:string; 
  res!:string; 
  resistenciamin!:string;
  resistenciamax!:string;    
 ...
 switch(this.banda3Select) {
      case 'black':
        this.res = this.resistencia;
        this.resistencia = this.resistencia + "Ω" + this.banda4;
        this.resistenciamax = ((parseFloat(this.res) + (parseFloat(this.res) * 0.05))*10).toString();
        this.resistenciamin = ((parseFloat(this.res) - (parseFloat(this.res) * 0.05))*10).toString();
        break;
      case 'brown':
        this.res = this.resistencia;
        this.resistencia = this.resistencia + '0Ω' + this.banda4;
        this.resistenciamax = ((parseFloat(this.res) + (parseFloat(this.res) * 0.05))*10).toString();
        this.resistenciamin = ((parseFloat(this.res) - (parseFloat(this.res) * 0.05))*10).toString();
        break;
      case 'red':
        this.res = this.resistencia;
        this.resistencia = this.resistencia + '00Ω' + this.banda4;
        this.resistenciamax = ((parseFloat(this.res) + (parseFloat(this.res) * 0.05))*10).toString();
        this.resistenciamin = ((parseFloat(this.res) - (parseFloat(this.res) * 0.05))*10).toString();
        break;
      case 'orange':
        this.res = this.resistencia;  
        this.resistencia = this.resistencia + '000Ω' + this.banda4;
        this.resistenciamax = ((parseFloat(this.res) + (parseFloat(this.res) * 0.05))*10).toString();
        this.resistenciamin = ((parseFloat(this.res) - (parseFloat(this.res) * 0.05))*10).toString();
        break;
      case 'yellow':
        this.res = this.resistencia;
        this.resistencia = this.resistencia + '0000Ω' + this.banda4;
        this.resistenciamax = ((parseFloat(this.res) + (parseFloat(this.res) * 0.05))*10).toString();
        this.resistenciamin = ((parseFloat(this.res) - (parseFloat(this.res) * 0.05))*10).toString();
        break;
      case 'green':
        this.res = this.resistencia;
        this.resistencia = this.resistencia + '00000Ω' + this.banda4;
        this.resistenciamax = ((parseFloat(this.res) + (parseFloat(this.res) * 0.05))*10).toString();
        this.resistenciamin = ((parseFloat(this.res) - (parseFloat(this.res) * 0.05))*10).toString();
        break;
      case 'blue':
        this.res = this.resistencia;
        this.resistencia = this.resistencia + '000000Ω' + this.banda4;
        this.resistenciamax = ((parseFloat(this.res) + (parseFloat(this.res) * 0.05))*10).toString();
        this.resistenciamin = ((parseFloat(this.res) - (parseFloat(this.res) * 0.05))*10).toString();
        break;
      case 'violet':
        this.res = this.resistencia;
        this.resistencia = this.resistencia + '0000000Ω' + this.banda4; 
        this.resistenciamax = ((parseFloat(this.res) + (parseFloat(this.res) * 0.05))*10).toString();
        this.resistenciamin = ((parseFloat(this.res) - (parseFloat(this.res) * 0.05))*10).toString();
        break;
      case 'grey':
        this.res = this.resistencia;
        this.resistencia = this.resistencia + '00000000Ω' + this.banda4; 
        this.resistenciamax = ((parseFloat(this.res) + (parseFloat(this.res) * 0.05))*10).toString();
        this.resistenciamin = ((parseFloat(this.res) - (parseFloat(this.res) * 0.05))*10).toString();
        break;
      case 'white':
        this.res = this.resistencia;
        this.resistencia = this.resistencia + '000000000Ω' + this.banda4;
        this.resistenciamax = ((parseFloat(this.res) + (parseFloat(this.res) * 0.05))*10).toString();
        this.resistenciamin = ((parseFloat(this.res) - (parseFloat(this.res) * 0.05))*10).toString();
        break;
    }
